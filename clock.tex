...
\@x{ {\EXTENDS} TLC ,\, Naturals ,\, Sequences ,\, FiniteSets}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} min ,\,}%
\@x{\@s{16.4} hr}%
\@pvspace{8.0pt}%
\@x{ ClockTypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land} min \.{\in} 0 \.{\dotdot} 59}%
\@x{\@s{16.4} \.{\land} hr \.{\in} 1 \.{\dotdot} 12}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor}\@s{4.1} \.{\land} min \.{\neq} 59}%
\@x{\@s{31.61} \.{\land} min \.{'} \.{=} min \.{+} 1}%
\@x{\@s{31.61} \.{\land} hr \.{'}\@s{4.42} \.{=} hr}%
\@x{\@s{16.4} \.{\lor}\@s{4.09} \.{\land} min \.{=} 59}%
\@x{\@s{31.61} \.{\land} min \.{'} \.{=} 0}%
 \@x{\@s{31.61} \.{\land} hr \.{'} \.{=} {\IF} hr \.{\neq} 12 \.{\THEN} hr
 \.{+} 1 \.{\ELSE} 1}%
\@pvspace{8.0pt}%
 \@x{ ClockSpec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} min ,\,
 hr {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
